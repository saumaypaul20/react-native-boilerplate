...
const DummyComp = () => {
    ...
    return (
        <>
            <View style={{backgroundColor: Colors.darkGray, paddingVertical:20, paddingHorizontal:30, borderRadius:10, marginTop:10, justifyContent:'center', alignItems:'center', elevation:10}}>
